(function () {
  ...
  var UI = {
    ...
    "enroll": "Записаться",
    "enrollLower": "записаться",
    "filterAll": "Все",
    "filterSection": "Раздел",
    "formConsent": "Согласен(на) на обработку персональных данных",
    "formLesson": "Занятие",
    ...
    "mapOpen": "Посмотреть на карте",
    "menu": "Меню",
    "menuClose": "Закрыть меню",
    "newTab": "{name}, откроется в новой вкладке",
    ...
    "place": "Место",
    "planPackage": "Абонемент / модуль",
    "planSingle": "Разовое",
    "planTrial": "Пробное",
    "price": "Цена",
    "priceNoSingle": "разового занятия нет",
    "priceNoTrial": "Пробного нет",
    "priceSingle": "разовое — {price}",
    "priceTrial": "Пробное — {price}",
    "privacy": "Политика обработки данных",
    "route": "Маршрут в Яндекс.Картах",
    "routeAria": "Маршрут в Яндекс.Картах, откроется в новой вкладке",
    "schoolNewTab": "{name} школы, откроется в новой вкладке",
    "sections": "Разделы",
    "sessionLink": "Смена «{title}», {dates}",
    "sessionPoster": "Афиша смены «{title}»",
    "shownCount": "Показано курсов: {shown} из {total}.",
    "shownNone": "По выбранным условиям ничего не нашлось — снимите часть фильтров.",
